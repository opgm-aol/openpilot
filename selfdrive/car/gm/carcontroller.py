...
from openpilot.selfdrive.car.gm.values import DBC, CanBus, CarControllerParams, CruiseButtons, GMFlags, CC_ONLY_CAR, SDGM_CAR, EV_CAR, CC_REGEN_PADDLE_CAR
...
class CarController(CarControllerBase):
  ...
  @staticmethod
  def calc_pedal_command(accel: float, long_active: bool) -> Tuple[float, bool]:
